...
def Reductor(X):
    ...
    # b – ширина обшивки (x1);
    # m – модуль колеса (x2);
    # z – число зубів колеса (x3 – ціла змінна);
    # l1 – довжина першого валу між підшипниками (x4);
    # l2 – довжина другого валу між підшипниками (x5);
    # d1 – діаметр першого валу (x6);
    # d2 – діаметр другого валу (x7)
